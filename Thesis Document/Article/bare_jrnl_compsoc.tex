...
\begin{figure}[!t]
	\centering
	\includegraphics[width=2.5in]{../images/e-puck.jpg}
...
\begin{figure}[!htp]
	...
	\caption{Screenshots from the video of an experiment. The virtual dangerous area is added as an overlay as a red disc.}
...
\section*{Contacts}
\textbf{Anthony Debruyn} -- Author\\
Email: \href{mailto:adebruyn@ulb.ac.be}{adebruyn@ulb.ac.be}\\
\textbf{Mauro Birattari} -- Promoter\\
Email: \href{mailto:mbiro@ulb.ac.be}{mbiro@ulb.ac.be}\\
\textbf{Marco Dorigo} -- Co-promoter\\
Email: \href{mailto:mdorigo@ulb.ac.be}{mdorigo@ulb.ac.be}\\
\textbf{Ga\"{e}tan Podevijn} -- Supervisor\\
Email: \href{mailto:gpodevij@ulb.ac.be}{gpodevij@ulb.ac.be}\\
\textbf{Andreagiovanni Reina} -- Supervisor\\
Email: \href{mailto:areina@ulb.ac.be}{areina@ulb.ac.be}
