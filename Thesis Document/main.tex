...
%////////////////////////////////////////////////////////////
	...
	$$\frac{\mbox{\textit{Surface}}}{\mbox{\textit{Perimeter}}} = \frac{r}{2}~\mbox{, where r is the radius of the circle.}$$
	...
	The final implementation of the controller is built on 2 layers. The upper layer is a deterministic finite state machine, having for each state a specific behaviour in the lower layer. Figure \ref{fig:state_machine} illustrates the whole structure of the upper layer. \\
