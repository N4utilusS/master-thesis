...
%		}
%		\end{tikzpicture}
		\includegraphics[scale=0.5]{tikz_external_figures/main-figure1.pdf}
		}
...
\chapter{Acknowledgements}
	...
	\begin{figure}[!htp]
		...
		\draw (-6,6) node[anchor=west, text width=13cm] {Anthony Antoun \color{Gray} for his help in the construction of the electronic part of the shoes};
		...
		\draw (-6,2) node[anchor=west, text width=13cm] {Lorenzo Garattoni \color{Gray} for the help provided in the arena when I needed it the most};
		\draw (-6,0) node[anchor=west, text width=13cm] {Family \& Friends \color{Gray} for their endless support from the beginning of my studies until now};
