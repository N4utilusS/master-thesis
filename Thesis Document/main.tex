...
\chapter{Summary}
	...
	\begin{abstract}
		The main objective of this master thesis is to introduce a new kind of protection. This protection is based on swarm robotics. A swarm of robots protects a human by augmenting his/her abilities in the sense that the robots provide feedback on the nature of the environment. In contrast with the current literature that mostly explores a one-way feedback from the human operator to the robots, our solution
	\end{abstract}
