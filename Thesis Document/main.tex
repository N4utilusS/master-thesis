...
\chapter{State of the Art}
	...
	\section{Swarm Robotics}
		...
		\citet{turgut2008self} proposed one of the first implementations of Reynolds' \citep{reynolds1987flocks} behaviour. Each robot knows the heading of the neighbours and their distance.
