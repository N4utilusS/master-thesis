...
{
	\draw [very thick] (#2,#3) circle [radius=0.5];
...
\chapter{Solution}
	...
	That means that fewer robots are needed for the same protected area, and more space for the human with a certain amount of robots.
	...
	\end{tikzpicture}
	\caption{Circle shape for the swarm to get the widest protected surface a given amount of robots.}
	\end{figure}
